export class BaseMongoRepository {
	 ...
	 */
	constructor(ravenService, model = null) {
	...
	async findOne(conditions, projection, options) {
		try {
			...
			throw this.ravenService.error(error, 'model findOne');
		}
	}
	...
	async find(conditions?, projection?, options?) {
		try {
			...
			throw this.ravenService.error(error, 'model find');
		}
	}
	...
	async create(doc) {
		try {
			...
			throw this.ravenService.error(error, 'model create');
		}
	}
	...
	async update(conditions, doc, options) {
		try {
			...
			throw this.ravenService.error(error, 'model update');
		}
	}
	...
	async findByIdAndUpdate(id, update, options) {
		try {
			...
			throw this.ravenService.error(error, 'model findByIdAndUpdate');
		}
	}
	...
	async findOneAndUpdate(conditions, update, options) {
		try {
			...
			throw this.ravenService.error(error, 'model findOneAndUpdate');
		}
	}
	...
	async remove(conditions) {
		try {
			...
			throw this.ravenService.error(error, 'model remove');
		}
	}
	...
	async count(conditions) {
		try {
			...
			throw this.ravenService.error(error, 'model count');
		}
	}
	...
	async aggregate(aggregation) {
		try {
			...
			throw this.ravenService.error(error, 'model aggregate');
		}
	}
